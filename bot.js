...
const forbiddenKeywords = [
  // Mots d'arnaqueurs
  "porno", "arnaqueurs","arnaque","c'est faux","fake","arnaqueur","marche pas","ça marche pas","score exact","Tu peux gagner plus de","iphone",  "gain","abonnement","Netflix","maître","rituel","magique", "aviator","229","drogue", "gagné", "coupon scores exact", "contacté moi",
